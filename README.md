...
- **Non-root User**: Runs as `github` user (security best practice)
...
|----------|-------------|---------|
| `GITHUB_TOKEN` | GitHub PAT with select permissions | `ghp_xxxxx...` |
| `ORG` | GitHub organization name | `my-org` |
| `LABELS` | Comma-separated runner labels | `linux,docker,self-hosted` |
